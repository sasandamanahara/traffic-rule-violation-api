...
from direction_detection import check_direction_violation
...
def draw_bounding_box(frame, x1, y1, x2, y2, speed):
        ...
        if results_vehicle and results_vehicle[0].boxes.id is not None:
            ...
            for box, obj_id, cls in zip(boxes, ids, classes):
                ...
                if is_inside_lines((cx, cy), line1, line2):
                    ...
                    # directions = check_direction_violation(obj_id, cx, cy, last_positions, directions, frame, x1, y1)
                ...
                draw_bounding_box(frame, x1, y1, x2, y2, speeds.get(obj_id, 0))
