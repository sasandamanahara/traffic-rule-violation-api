...
from detect_seperate_violations.direction_violation_processor import detect_direction_violation_in_video
from detect_seperate_violations.speed_violation_processor import detect_speed_violation_in_video
from detect_seperate_violations.noparking_violation_processor import detect_noparking_violation_in_video
...
@api_bp.route('/process-video-direction', methods=['POST'])
def process_video_route_direction():
    """Process video only for traffic light violation"""
    ...
    try:
        ...
        result_json = detect_direction_violation_in_video(
            input_video_path=input_path,
            snapshot_folder=Config.SNAPSHOT_FOLDER,
            output_video_folder=Config.OUTPUT_VIDEO_FOLDER
        )
...
@api_bp.route('/process-video-speed', methods=['POST'])
def process_video_speed():
    """Process video only for traffic light violation"""
    ...
    try:
        ...
        result_json = detect_speed_violation_in_video(
            input_video_path=input_path,
            snapshot_folder=Config.SNAPSHOT_FOLDER,
            output_video_folder=Config.OUTPUT_VIDEO_FOLDER
        )
...
@api_bp.route('/process-video-noparking', methods=['POST'])
def process_video_noparking():
    """Process video only for traffic light violation"""
    ...
    try:
        ...
        result_json = detect_noparking_violation_in_video(
            input_video_path=input_path,
            snapshot_folder=Config.SNAPSHOT_FOLDER,
            output_video_folder=Config.OUTPUT_VIDEO_FOLDER
        )
